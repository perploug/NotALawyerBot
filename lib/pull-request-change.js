        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // In progress feedback
                    _a.sent();
                    lookup = new Lookup_1.default(cfg);
                    return [4 /*yield*/, lookup.run(context)];
                case 3:
                    results = _a.sent();
                    ...
                    body = lookup.render();
                    checkResult.output.summary = app_1.AppConfig.description;
                ...
                case 4:
                    ...
                    return [4 /*yield*/, context.github.issues.updateComment(__assign({}, repo, { comment_id: comment.id, body: body }))];
                case 5:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, context.github.issues.createComment(__assign({}, issue, { body: body }))];
                case 7:
                    _a.sent();
                    _a.label = 8;
