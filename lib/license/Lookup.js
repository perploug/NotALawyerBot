...
var Lookup = /** @class */ (function () {
    function Lookup(config, context, baseLicense, onlyNew) {
        if (baseLicense === void 0) { baseLicense = undefined; }
        ...
        if (baseLicense) {
            ...
            this._config.onlyAllow = licensetypes_1.FindCompatible(baseLicense);
        }
        else {
    ...
    Lookup.prototype.run = function (repo, ref, pr) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var files, pr_contents, repo_contens, ll, matches, _i, matches_1, match, deps, head_response, head_content, base, base_response, base_content, base_deps, baseDepsKeys, repo_response, repo_content, deps_lookup, _a, deps_lookup_1, dd, ex_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        deps = _b.sent();
                        if (!(this._onlyNew == false)) return [3 /*break*/, 11];
