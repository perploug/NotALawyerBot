...
var Lookup = /** @class */ (function () {
    ...
    Lookup.prototype._buildConfig = function (config) {
        function parse(licenses) {
            for (var _i = 0, _a = Object.keys(licensetypes_1.LicenseTypes); _i < _a.length; _i++) {
                var group = _a[_i];
                var groupIndex = licenses.indexOf(group);
                if (groupIndex >= 0) {
                    licenses.splice(groupIndex, 1);
                    licenses = licenses.concat(licensetypes_1.LicenseTypes[group.toString()]);
                }
            }
        }
    ...
    Lookup.prototype._licenseBanned = function (license, config) {
        if (!license) {
    ...
    Lookup.prototype.run = function (context, config) {
        return __awaiter(this, void 0, void 0, function () {
